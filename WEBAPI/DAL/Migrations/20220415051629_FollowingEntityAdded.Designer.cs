...
namespace DAL.Migrations
{
    ...
    [Migration("20220415051629_FollowingEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Entities.Connection", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Entities.UserFollowing", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Entities.UserLike", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Entities.Comment", b =>
                {
                    b.HasOne("EntityLayer.Entities.AppUser", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId");

                    b.HasOne("EntityLayer.Entities.Photo", "Photo")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("EntityLayer.Entities.Message", b =>
                {
                    b.HasOne("EntityLayer.Entities.AppUser", "Recipient")
            ...
            modelBuilder.Entity("EntityLayer.Entities.UserFollowing", b =>
                {
                    b.HasOne("EntityLayer.Entities.AppUser", "Observer")
                        .WithMany("Followings")
                        .HasForeignKey("ObserverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityLayer.Entities.AppUser", "Target")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("EntityLayer.Entities.UserLike", b =>
                {
                    b.HasOne("EntityLayer.Entities.AppUser", "LikedUser")
                        .WithMany("LikedByUsers")
                        .HasForeignKey("LikedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityLayer.Entities.AppUser", "SourceUser")
                        .WithMany("LikedUsers")
